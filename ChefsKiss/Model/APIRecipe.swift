...
struct APIRecipe: Codable, Hashable {
...
//     }
//     
//     init(id: Int, title: String, summary: String, image: String, imageType: String, readyInMinutes: Int, servings: Int, analyzedInstructions: [Instruction]) {
//         self.id = id
//         self.title = title
