...
//                            }
                ...
                Section("Instructions") {
                    // MARK: - NEW CODE
//                    InstructionsListView(instructions: viewModel.steps, deleteCallback: viewModel.deleteStep)
...
//   @State var instructions: [Recipe.Step]
//    let deleteCallback: (IndexSet) -> ()
//    
//    var body: some View {
//        List {
//            ForEach(instructions.enumerated(), id: \.element.id) { index, step in
//                HStack {
//                    Text("\(index + 1)")
//                    Text(instructions[index].stepDetail)
//                }
//            }
