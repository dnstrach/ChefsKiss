...
struct EditInstructionSheetView: View {
    ...
    @State var instruction: MyRecipe.Instruction
    ...
    func storeInitialStep(_ instruction: MyRecipe.Instruction) {
        step = instruction.step
    }
    
    func editInstruction(_ instruction: MyRecipe.Instruction) {
