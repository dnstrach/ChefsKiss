...
struct EditIngredientSheetView: View {
    ...
    @State var ingredient: MyRecipe.Ingredient
    ...
    func storeInitialIngredient(_ ingredient: MyRecipe.Ingredient) {
        ingredientName = ingredient.name
        measurement = ingredient.measurement
        measurementType = ingredient.measurementType
    }
    
    func editIngredient(_ instruction: MyRecipe.Ingredient) {
